...
DESIGN &
DEVELOPMENT
From zero clients to a fully operational freelance business
8 Modules | 47 Lessons | 12 Templates
FREE Modules 1–3 | PAID $27 Modules 4–8

---

TABLE OF CONTENTS

[FREE] MODULE 1 — Mindset & Market Reality
...
[FREE] MODULE 2 — Skills, Tools & Tech Stack
...
[FREE] MODULE 3 — Portfolio That Converts
...
[PAID] MODULE 4 — Pricing: What to Charge & How to Say It
4.1 The 3 Pricing Models and When to Use Each
4.2 How to Set Your Rates — The Real Formula
4.3 Packaging Your Services
4.4 The Pricing Conversation
4.5 Raising Rates & Eliminating Low-Budget Clients

[PAID] MODULE 5 — Finding Clients: The Full System
5.1 The Client Acquisition Matrix
5.2 Warm Outreach & Network Activation
5.3 Cold Outreach That Gets Responses
5.4 Freelance Platforms — The Smart Way
5.5 Content Marketing & Inbound (The Long Game)
5.6 Partnerships & Referral Networks

[PAID] MODULE 6 — Sales: From Lead to Signed Contract
6.1 The Discovery Call Framework
6.2 Writing Proposals That Win
6.3 Handling Objections Like a Pro
6.4 Contracts: Protect Yourself Before Work Starts
6.5 Invoicing & Getting Paid on Time

[PAID] MODULE 7 — Client Management & Project Delivery
7.1 The Client Onboarding System
7.2 Communication Protocols That Prevent 95% of Problems
7.3 Managing Revisions Without Losing Your Mind
7.4 Project Delivery & Launch
7.5 Retaining Clients for Monthly Revenue

[PAID] MODULE 8 — Scaling: From Freelancer to Business
8.1 Business Foundations & Legal Setup
8.2 Building Systems That Scale
8.3 Building Your Personal Brand
8.4 Hiring, Outsourcing & Building a Team
8.5 Income Diversification & Passive Revenue

---

MODULE 1 — Mindset & Market Reality
LESSON 1.1
...
[TABLE_START]
Phase	Timeline	Monthly Revenue	Your #1 Focus
Phase 1: Survival	Months 1–3	$0 – $2,000	First 2–3 clients, proof of concept
Phase 2: Stability	Months 4–9	$2,000 – $6,000	Repeatable pipeline, retainers
Phase 3: Scale	Month 10+	$6,000 – $15,000+	Systems, team, passive income
[TABLE_END]
...
[TABLE_START]
Vague (avoid)	Good	Excellent
Web designer	Web designer for restaurants	Webflow designer for upscale restaurants in NYC
WordPress developer	WordPress developer for coaches	WordPress + membership sites for online business coaches
Website builder	E-commerce developer	Shopify developer for beauty & cosmetics brands
UI/UX designer	Designer for SaaS startups	Mobile-first UI designer for B2B SaaS products
[TABLE_END]
...
[TABLE_START]
Criterion	What to Ask	Score /5
Market size	Are there thousands of potential clients?
Willingness to pay	Do they spend money on marketing?
Your interest/knowledge	Do you already know this industry?
Competition level	Are there few niche specialists?
Recurring revenue potential	Do they need ongoing maintenance?
[TABLE_END]
...
[TABLE_START]
Timeline	Realistic Monthly Revenue	How to Get There
Month 1	$0 – $800	1 small project or 1 free project for testimonial
Month 2	$500 – $2,000	1–2 paid projects, word-of-mouth starting
Month 3	$1,500 – $4,000	2–3 projects, first retainer client
Month 6	$3,000 – $7,000	Steady pipeline, raised rates, repeat clients
...
Most freelancers fail from lack of system, not lack of skill.
Pick your stack (WordPress or Webflow recommended) and commit for 90 days.
Niche down immediately — specialists earn 2–3x generalists.
Write your 90-day plan this week. Then execute it one week at a time.
...
[TABLE_START]
Factor	WordPress + Elementor	Webflow
Learning curve	Moderate (2–4 weeks)	Moderate-high (4–8 weeks)
Client base	SMBs, local businesses, blogs	Agencies, startups, tech companies
Typical project rate	$800–$5,000	$2,000–$12,000
Hosting	Client manages	Webflow Hosting (built-in)
Code quality	Variable (plugin-dependent)	Clean semantic HTML/CSS
Job market size	Enormous	Growing fast, niche premium
[TABLE_END]
...
Coolors.co — instant color palette generator
Google Fonts — 1,000+ free professional fonts
Unsplash.com — free high-quality stock photography
Awwwards.com — inspiration from award-winning websites
Refero.design — real-world UI design references
UI Patterns (ui-patterns.com) — common UI solution library
...
Framer AI — Landing Page Generation
...
PROBLEM: What was broken or missing before you got involved? Make it relatable.
PROCESS: How did you approach solving it? Show your thinking, not just your output.
RESULT: What changed? Use numbers wherever possible. 'Bookings increased 40%' is infinitely more convincing than 'The client was happy.'
...
Non-profit / Charity Work — HIGH VALUE
...
Friends & Family Businesses — MEDIUM VALUE
...
Open Source / Community Projects — MEDIUM VALUE
...
Hi [Name],
I've been following [Business Name] for a while — love what you're doing. I'm a web designer specializing in [their industry], and I noticed your current site could be updated to better reflect the quality of your work.
I've taken the liberty of mocking up a redesign concept — no strings attached. Would you like me to send it over?
Best, [Your Name]
...
[TABLE_START]
Platform	Best For	Cost Pros
Webflow	Webflow specialists	$14/mo Showcases your Webflow skills directly
Framer	Modern/startup aesthetic	$10/mo Beautiful animations, fast
WordPress	WordPress specialists	$5–20/mo hosting Full control, familiar
Hand-coded HTML/CSS	Frontend developers	~$3/mo hosting Maximum credibility to dev clients
Squarespace/Wix	Quick setup	$16–25/mo Easy but limited customization
[TABLE_END]
...
3+ case studies published with the Problem-Process-Result formula
A professional portfolio website with all 5 essential pages
A working contact form and professional email address
Passed the 10-point review checklist
This is the foundation that will get you your first paying client.
...
const moduleIntros: Record<string, { title: string; quote: string; milestone: string }> = {
  'MODULE 1': {
    title: 'Mindset & Market Reality',
    quote: 'Understand the game before you play it',
    milestone: 'Written 90-day plan + niche hypothesis',
  },
  'MODULE 2': {
    title: 'Skills, Tools & Tech Stack',
    quote: 'Get tool-ready — know what to learn, skip the rest',
    milestone: 'Working demo site published live',
  },
  'MODULE 3': {
    title: 'Portfolio That Converts',
    quote: 'Your silent salesperson â€” make it work 24/7',
    milestone: 'Live portfolio with 3+ case studies published',
  },
}

function parseModules(raw: string): ModuleData[] {
  const moduleKeys = ['MODULE 1', 'MODULE 2', 'MODULE 3']
  const modules: ModuleData[] = []
  const contentStart = raw.indexOf('---\n\nMODULE 1')
  const courseBody = raw.slice(contentStart === -1 ? 0 : contentStart)
  const allLessons: Lesson[] = []
  const lessonRegex = /LESSON (\d+\.\d+)\n([^\n]+)\n([\s\S]*?)(?=\nLESSON \d+\.\d+|$)/g
  let match

  while ((match = lessonRegex.exec(courseBody)) !== null) {
    const [, id, title, content] = match
    allLessons.push({ id, title: title.trim(), content: content.trim() })
  }

  for (let i = 0; i < moduleKeys.length; i++) {
    const moduleIntro = moduleIntros[moduleKeys[i]]
    const moduleNumber = String(i + 1)
    const lessons = allLessons.filter((lesson) => lesson.id.startsWith(`${moduleNumber}.`))

    modules.push({
      id: moduleKeys[i],
      title: moduleIntro.title,
      intro: '',
      quote: moduleIntro.quote,
      milestone: moduleIntro.milestone,
      lessons,
    })
  }
...
const modules = parseModules(freeCourseText)

function LessonCard({ lesson, moduleNum }: { lesson: Lesson; moduleNum: string }) {
  const subtitle = lesson.content.split('\n')[0] || ''
  ...
  const renderContent = () => {
    ...
    const titleHeaders = [
      ...
      'The Document That Separates Dreamers from Earners',
      'The Tool Trap: Why Less Is More',
      "You Don't Need to Be an Artist â€” You Need to Know the Rules",
      'How Professional Projects Actually Run',
      'AI Is the Unfair Advantage Available to Every Freelancer',
      'Your Demo Site Is Your #1 Sales Tool',
      'Your Portfolio Is a Sales Tool, Not a Gallery',
      'The Classic Catch-22 â€” and How to Break It',
      'Case Studies Are Your Most Powerful Sales Tool',
      'Your Portfolio Site Is Your Permanent First Impression',
      'Never Send a Portfolio Link Without Running This Checklist',
    ]
    ...
    const isTitleHeader = (value: string) => titleHeaders.some((header) => normalizeLine(header) === normalizeLine(value))
    const isSubtitleHeader = (value: string) => subtitleHeaders.some((header) => normalizeLine(header) === normalizeLine(value))
    const renderInlineText = (text: string): React.ReactNode[] => {
      ...
      const formatWithRules = (value: string, activeRules = rules): React.ReactNode[] => {
        let segments: React.ReactNode[] = [value]
        ...
        activeRules.forEach((rule) => {
          segments = segments.flatMap((segment, segmentIndex) => {
            ...
            while ((match = pattern.exec(segment)) !== null) {
              ...
              parts.push(rule.render(match[0], segmentIndex + match.index))
      ...
      const boldPrefixes = [
        ...
        'CMS / Builder â€” WordPress + Elementor OR Webflow:',
        'Local Dev â€” Local by Flywheel:',
        'Version Control â€” GitHub:',
        'Safe starter palettes for business sites:',
        'Contrast:',
        'Repetition:',
        'Alignment:',
        'Proximity:',
      ...
      const boldPrefixPatterns = [
        /^Mobile-first rule:/,
        /^Design\s+.+\s+Figma:/,
        /^Code Editor\s+.+\s+VS Code:/,
        /^CMS \/ Builder\s+.+\s+WordPress \+ Elementor OR Webflow:/i,
        /^Local Dev\s+.+\s+Local by Flywheel:/,
        /^Version Control\s+.+\s+GitHub:/,
        /^AI Assist\s+.+\s+Claude or GitHub Copilot:/,
        /^Project Management\s+.+\s+Notion or Trello:/,
        /^Invoicing\s+.+\s+Wave or Bonsai:/,
      ]
      const patternPrefix = boldPrefixPatterns.map((pattern) => text.match(pattern)?.[0]).find(Boolean)
      ...
      const nicheDimensionMatch = text.match(/^(A strong niche has up to three dimensions:\s+)(Who)( \([^)]+\), )(What)( \([^)]+\), and )(Where)( \([^)]+\)\..*)$/)
      ...
      const industryMatch = text.match(/^([A-Z][A-Za-z &/()]+):(\s+.*)$/)
    ...
    mainLoop: while (i < contentLines.length) {
      ...
      if (line.trim() === '[TABLE_START]') {
        ...
        let j = i + 1
        while (j < contentLines.length && contentLines[j].trim() !== '[TABLE_END]') {
          if (contentLines[j].trim() !== '') {
            tableRows.push(contentLines[j].split('\t'))
          }
          j++
        }
        ...
        if (tableRows.length > 0) {
          ...
          elements.push(
            <TableComponent key={`table-${i}`} headers={headers} rows={rows} />
          )
        }
        
        i = j + 1 // Skip past [TABLE_END]
        continue mainLoop
      }
      ...
      if (line.includes('\t')) {
        const tableRows: string[][] = []
        let j = i
        while (j < contentLines.length && contentLines[j].trim() !== '[TABLE_END]' && contentLines[j].includes('\t')) {
          tableRows.push(contentLines[j].split('\t'))
          j++
        }

        if (tableRows.length > 1 && contentLines[j]?.trim() === '[TABLE_END]') {
          const headers = tableRows[0]
          const rows = tableRows.slice(1)
          elements.push(
            <TableComponent key={`table-${i}`} headers={headers} rows={rows} />
      ...
      const normalTextHeaders = [
        'What the First 90 Days Actually Look Like',
        "The 'Learn vs. Earn' Balance",
        'What to Include in Each Portfolio Project',
        'WordPress vs. Webflow: The Real Comparison',
      ]
      const isSpecialHeader = (value: string) => specialHeaders.some((header) => normalizeLine(header) === normalizeLine(value))
      const isNormalTextHeader = (value: string) => normalTextHeaders.some((header) => normalizeLine(header) === normalizeLine(value))

      if (isSpecialHeader(line)) {
        flushCurrentSection(`p-${i}`)

        const specialSectionContent: string[] = []
        let j = i + 1
        while (j < contentLines.length && 
               !contentLines[j].includes('ACTION TASK') && 
               !contentLines[j].includes('MODULE') && 
               !contentLines[j].includes('TABLE_START') && 
               !contentLines[j].includes('TABLE_END') &&
               !isSpecialHeader(contentLines[j]) &&
               !isNormalTextHeader(contentLines[j])) {
          specialSectionContent.push(contentLines[j])
          j++
        }
      ...
      if (line.includes('ACTION TASK')) {
        flushCurrentSection(`p-${i}`)

        const taskContent: string[] = []
        let j = i + 1
        while (j < contentLines.length && !contentLines[j].includes('ACTION TASK') && !contentLines[j].includes('MODULE')) {
          taskContent.push(contentLines[j])
          j++
        }
        elements.push(
          <ActionTask key={`action-${i}`} title={line} variant="action">
      ...
      if (line.includes('MILESTONE')) {
        ...
        let j = i + 1
        while (j < contentLines.length && !contentLines[j].includes('ACTION TASK') && !contentLines[j].includes('MODULE') && !contentLines[j].includes('MILESTONE')) {
          milestoneContent.push(contentLines[j])
          j++
        }
        elements.push(
          <ActionTask key={`milestone-${i}`} title={line} variant="milestone">
            <ul className="list-none space-y-2">
              {milestoneContent
                .filter((l) => l.trim())
                .map((item, idx) => (
...
function ModulePanel({ module, moduleNum }: { module: ModuleData; moduleNum: string }) {
  return (
    <section className="mb-16">
      <ModuleIntro module={module} moduleNum={moduleNum} />

      <div className="space-y-8">
        {module.lessons.map((lesson) => (
          <LessonCard key={lesson.id} lesson={lesson} moduleNum={moduleNum} />
        ))}
      </div>
    </section>
  )
